...
The 14:1 odds may come from an examination of the p value, wich is 0.06091. With 14:1 odds, you have a 93.33% probability of one outcome happening and a 6.67% of the other outcome happening.
```{r}
# 1. Conduct a t-test using the “head corn” yield data shown below. Can you guess/explain where the 14:1 odds come from?
